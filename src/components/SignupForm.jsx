...
const SignupForm = () => {
  ...
  return showPopup ? (
    <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50">
      ...
      <img
    src="https://mcusercontent.com/e1f1a4e7afa29f4705570bedf/images/e212dfae-95cb-0a7c-afb0-47948cedbf32.png"  // Replace with your image URL
    alt="Newsletter"
    className="w-full h-64 object-cover rounded-t-lg"  // Adjusting to cover the full width
  />
        {!submitted ? (
          <form onSubmit={handleSubmit} className="">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                className="mt-1 px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-pink200 focus:shadow focus:shadow-pink200/30"
                required
              />
            </div>
            <button
            ...
            Join our community and be the first to know about new courses, exclusive offers, and more.            </p>
            </div>
          </form>
        ) : (
