...
const YouWillLearn = () => {
  return (
    ...
    <h2 className="text-white text-4xl  font-medium-fgm font-bold mb-8 uppercase font-medium-fgm">WHAT WILL YOU LEARN</h2>
    <div className="md:flex md:space-x-8">
      {/* First Section */}
      <div className="flex-1">
       <div>
       <h4 className="text-white text-xl  font-medium-fgm mb-4 mt-5 ">Getting Started with Your Art Journey</h4>
        <ul className="list-disc list-inside text-sm 2xl:text-lg text-pink200 space-y-2 font-medium-fgm">
       ...
       <div>
       <h4 className="text-white text-xl  font-medium-fgm mb-4 mt-5">Basic Art Fundamentals</h4>
        <ul className="list-disc list-inside text-sm 2xl:text-lg text-pink200 space-y-2 font-medium-fgm">
...
<li>Build a solid foundation that will help you tackle any artistic challenge with confidence.</li>
       ...
       <div>
       <h4 className="text-white text-xl  font-medium-fgm mb-4 mt-5">Gesture Drawing</h4>
        <ul className="list-disc list-inside text-sm 2xl:text-lg text-pink200 space-y-2 font-medium-fgm">
...
<li> Understand the importance of rhythms to incorporate natural flow into your drawings, giving them an organic feel.</li>
      ...
      <div className="flex-1">
        <div>
        <h4 className="text-white text-xl  font-medium-fgm mb-4 mt-5">ANIMATION</h4>
        <ul className="list-disc list-inside text-sm 2xl:text-lg text-pink200 space-y-2 font-medium-fgm">
...
<li>Explore both traditional and digital animation techinques that you can apply to your own projects.</li>
        ...
        <div>
        <h4 className="text-white text-xl  font-medium-fgm mb-4 mt-5">Digital Painting</h4>
        <ul className="list-disc list-inside text-sm 2xl:text-lg text-pink200 space-y-2 font-medium-fgm">
...
<li> Learn how to add intricate details, textures, and finishing touches yo your digital artwork for a polished look.</li>
        ...
        <div>
        <h4 className="text-white text-xl  font-medium-fgm mb-4 mt-5">Character Creation</h4>
        <ul className="list-disc list-inside text-sm 2xl:text-lg text-pink200 space-y-2 font-medium-fgm">
