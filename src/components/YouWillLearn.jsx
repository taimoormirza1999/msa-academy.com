...
const YouWillLearn = () => {
  return (
    ...
    <div className="mx-auto mt-16 bg-black/50 md:bg-black/40 py-8 px-6 md:p-10  rounded-primary w-90 md:w-85 shadow-2xl shadow-pink200/40" >
    <h2 className="text-white text-4xl font-ImpactCustom mb-8">WHAT WILL YOU LEARN</h2>
